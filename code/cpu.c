...
static const OpcodeFunction opcodes[256] = {
  ins_brk, ins_ora_idx, NULL, NULL, NULL, ins_ora_zp, ins_asl_zp, NULL, ins_php, ins_ora_im, ins_asl_acc, NULL, NULL, ins_ora_abs, ins_asl_abs, NULL,
  ins_bpl, ins_ora_idy, NULL, NULL, NULL, ins_ora_zpx, ins_asl_zpx, NULL, ins_clc, ins_ora_aby, NULL, NULL, NULL, ins_ora_abx, ins_asl_abx, NULL,
  ins_jsr, ins_and_idx, NULL, NULL, ins_bit_zp, ins_and_zp, ins_rol_zp, NULL, ins_plp, ins_and_im, ins_rol_acc, NULL, ins_bit_abs, ins_and_abs, ins_rol_abs, NULL,
  ins_bmi, ins_and_idy, NULL, NULL, NULL, ins_and_zpx, ins_rol_zpx, NULL, ins_sec, ins_and_aby, NULL, NULL, NULL, ins_and_abx, ins_rol_abx, NULL,
  ins_rti, ins_eor_idx, NULL, NULL, NULL, ins_eor_zp, ins_lsr_zp, NULL, ins_pha, ins_eor_im, ins_lsr_acc, NULL, ins_jmp_abs, ins_eor_abs, ins_lsr_abs, NULL,
  ins_bvc, ins_eor_idy, NULL, NULL, NULL, ins_eor_zpx, ins_lsr_zpx, NULL, ins_cli, ins_eor_aby, NULL, NULL, NULL, ins_eor_abx, ins_lsr_abx, NULL,
  ins_rts, ins_adc_idx, NULL, NULL, NULL, ins_adc_zp, ins_ror_zp, NULL, ins_pla, ins_adc_im, ins_ror_acc, NULL, ins_jmp_ind, ins_adc_abs, ins_ror_abs, NULL,
  ins_bvs, ins_adc_idy, NULL, NULL, NULL, ins_adc_zpx, ins_ror_zpx, NULL, ins_sei, ins_adc_aby, NULL, NULL, NULL, ins_adc_abx, ins_ror_abx, NULL,
  NULL, ins_sta_idx, NULL, NULL, ins_sty_zp, ins_sta_zp, ins_stx_zp, NULL, ins_dey, NULL, ins_txa, NULL, ins_sty_abs, ins_sta_abs, ins_stx_abs, NULL,
  ins_bcc, ins_sta_idy, NULL, NULL, ins_sty_zpx, ins_sta_zpx, ins_stx_zpy, NULL, ins_tya, ins_sta_aby, ins_txs, NULL, NULL, ins_sta_abx, NULL, NULL,
  ins_ldy_im, ins_lda_idx, ins_ldx_im, NULL, ins_ldy_zp, ins_lda_zp, ins_ldx_zp, NULL, ins_tay, ins_lda_im, ins_tax, NULL, ins_ldy_abs, ins_lda_abs, ins_ldx_abs, NULL,
  ins_bcs, ins_lda_idy, NULL, NULL, ins_ldy_zpx, ins_lda_zpx, ins_ldx_zpy, NULL, ins_clv, ins_lda_aby, ins_tsx, NULL, ins_ldy_abx, ins_lda_abx, ins_ldx_aby, NULL,
  ins_cpy_im, ins_cmp_idx, NULL, NULL, ins_cpy_zp, ins_cmp_zp, ins_dec_zp, NULL, ins_iny, ins_cmp_im, ins_dex, NULL, ins_cpy_abs, ins_cmp_abs, ins_dec_abs, NULL,
  ins_bne, ins_cmp_idy, NULL, NULL, NULL, ins_cmp_zpx, ins_dec_zpx, NULL, ins_cld, ins_cmp_aby, NULL, NULL, NULL, ins_cmp_abx, ins_dec_abx, NULL,
  ins_cpx_im, ins_sbc_idx, NULL, NULL, ins_cpx_zp, ins_sbc_zp, ins_inc_zp, NULL, ins_inx, ins_sbc_im, ins_nop, NULL, ins_cpx_abs, ins_sbc_abs, ins_inc_abs, NULL,
  ins_beq, ins_sbc_idy, NULL, NULL, NULL, ins_sbc_zpx, ins_inc_zpx, NULL, ins_sed, ins_sbc_aby, NULL, NULL, NULL, ins_sbc_abx, ins_inc_abx, NULL
}; 
